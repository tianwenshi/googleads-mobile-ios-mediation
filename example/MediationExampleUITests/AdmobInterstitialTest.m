...
@interface AdmobInterstitialTest : XCTestCase
@property (nonatomic, strong) XCUIApplication *app;
@end

@implementation AdmobInterstitialTest
...
-(void)testLoadInterstitialClosed {
    XCUIElement *Label = self.app.staticTexts[@"Objective-C Custom Event"];
    XCTAssertTrue(Label.exists, @"Objective-C Custom Event not found!");
    [Label tap];
    sleep(10);
...
-(void)testLoadInterstitialClicked {
    XCUIElement *Label = self.app.staticTexts[@"Objective-C Custom Event"];
    XCTAssertTrue(Label.exists, @"Objective-C Custom Event not found!");
    [Label tap];
    sleep(10);
